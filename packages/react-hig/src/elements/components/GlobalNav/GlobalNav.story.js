        ...
        <SideNav>
          <SectionList>
            <Section headerLabel="Project" headerName="ThunderStorm">
              <Group>
                <Item icon="project-management" title="Item 1" link="#" onClick={action('clicked')} />
                <Item icon="project-management" title="Item 2" link="#" onClick={action('clicked')} />
                <Item icon="project-management" title="Item 3" link="#" onClick={action('clicked')} />
              </Group>
            </Section>
            <Section headerLabel="Project" headerName="Thunderstorm">
              <Group>
