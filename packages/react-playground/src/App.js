...
import {
  ...
  Select,
  Datepicker
} from '@orion-ui/react-components/lib/2016-12-01';
      ...
      <div className="App">
        ...
        <div style={{ margin: '40px' }}>
          ...
          <Select
            ...
            options={this.state.buttonSizes}
            selectedIndex={this.state.selectedIndex}
            onChange={this.setSelectedIndex}
          />
          <button onClick={this.toggleDisabled}>Toggle disabled</button>
          <button onClick={this.toggleDisabledOption}>
        ...
        <div style={{ margin: '40px' }}>
          ...
          <div style={{ margin: '40px' }}>
            <input
              ...
              onChange={this.setDisplayFormat}
              placeholder="Display format"
            />
            <Select
              options={this.locales}
              selectedIndex={this.state.localeIndex}
